...
typedef enum {
    ...
    JG_E_FREAD = 11,
    JG_E_ERRNO_FOPEN = 12,
    JG_E_ERRNO_FCLOSE = 13,
    JG_E_ERRNO_FSEEKO = 14,
    JG_E_ERRNO_FTELLO = 15,
    JG_E_PARSE_INVALID_TYPE = 16,
    JG_E_PARSE_UNTERM_STR = 17,
    JG_E_PARSE_UNTERM_ARR = 18,
    JG_E_PARSE_UNTERM_OBJ = 19,
    JG_E_PARSE_FALSE = 20,
    JG_E_PARSE_TRUE = 21,
    JG_E_PARSE_NULL = 22,
    JG_E_PARSE_NUM_SIGN = 23,
    JG_E_PARSE_NUM_LEAD_ZERO = 24,
    JG_E_PARSE_NUM_INVALID = 25,
    JG_E_PARSE_NUM_MULTIPLE_POINTS = 26,
    JG_E_PARSE_NUM_EXP_HEAD_INVALID = 27,
    JG_E_PARSE_NUM_EXP_INVALID = 28,
    JG_E_PARSE_NUM_TOO_LARGE = 29,
    JG_E_PARSE_STR_UTF8_INVALID = 30,
    JG_E_PARSE_STR_UNESC_CONTROL = 31,
    JG_E_PARSE_STR_ESC_INVALID = 32,
    JG_E_PARSE_STR_UTF16_INVALID = 33,
    JG_E_PARSE_STR_UTF16_UNPAIRED_HIGH = 34,
    JG_E_PARSE_STR_UTF16_UNPAIRED_LOW = 35,
    JG_E_PARSE_STR_TOO_LARGE = 36,
    JG_E_PARSE_ARR_INVALID_SEP = 37,
    JG_E_PARSE_OBJ_INVALID_KEY = 38,
    JG_E_PARSE_OBJ_KEYVAL_INVALID_SEP = 39,
    JG_E_PARSE_OBJ_INVALID_SEP = 40,
    JG_E_PARSE_OBJ_DUPLICATE_KEY = 41,
    JG_E_PARSE_ROOT_SURPLUS = 42,
    JG_E_GET_NOT_NULL = 43,
    JG_E_GET_NOT_BOOL = 44,
    JG_E_GET_NOT_NUM = 45,
    JG_E_GET_NOT_STR = 46,
    JG_E_GET_NOT_ARR = 47,
    JG_E_GET_NOT_OBJ = 48,
    JG_E_GET_ARR_INDEX_OVER = 49,
    JG_E_GET_ARR_TOO_SHORT = 50,
    JG_E_GET_ARR_TOO_LONG = 51,
    JG_E_GET_OBJ_KEY_NOT_FOUND = 52,
    JG_E_GET_OBJ_TOO_SHORT = 53,
    JG_E_GET_OBJ_TOO_LONG = 54,
    JG_E_GET_STR_BYTE_C_TOO_FEW = 55,
    JG_E_GET_STR_BYTE_C_TOO_MANY = 56,
    JG_E_GET_STR_CHAR_C_TOO_FEW = 57,
    JG_E_GET_STR_CHAR_C_TOO_MANY = 58,
    JG_E_GET_NUM_NOT_INTEGER = 59,
    JG_E_GET_NUM_NOT_UNSIGNED = 60,
    JG_E_GET_NUM_SIGNED_TOO_SMALL = 61,
    JG_E_GET_NUM_SIGNED_TOO_LARGE = 62,
    JG_E_GET_NUM_UNSIGNED_TOO_SMALL = 63,
    JG_E_GET_NUM_UNSIGNED_TOO_LARGE = 64,
    JG_E_GET_NUM_NOT_FLO = 65,
    JG_E_GET_NUM_FLOAT_OUT_OF_RANGE = 66,
    JG_E_GET_NUM_DOUBLE_OUT_OF_RANGE = 67,
    JG_E_GET_NUM_LONG_DOUBLE_OUT_OF_RANGE = 68,
    JG_E_SET_ROOT_ALREADY_SET = 69, // todo: handle JG_E_SET_* correctly
    JG_E_SET_NOT_ARR = 70,
    JG_E_SET_NOT_OBJ = 71,
    JG_E_SET_DUPLICATE_KEY = 72
} jg_ret;
