...
typedef enum {
    ...
    JG_E_GET_NOT_NULL = 48,
    JG_E_GET_NOT_BOOL = 49,
    JG_E_GET_NOT_NUM = 50,
    JG_E_GET_NOT_STR = 51,
    JG_E_GET_NOT_ARR = 52,
    JG_E_GET_NOT_OBJ = 53,
    JG_E_GET_ARR_INDEX_OVER = 54,
    JG_E_GET_ARR_TOO_SHORT = 55,
    JG_E_GET_ARR_TOO_LONG = 56,
    JG_E_GET_OBJ_KEY_NOT_FOUND = 57,
    JG_E_GET_OBJ_TOO_SHORT = 58,
    JG_E_GET_OBJ_TOO_LONG = 59,
    JG_E_GET_STR_BYTE_C_TOO_FEW = 60,
    JG_E_GET_STR_BYTE_C_TOO_MANY = 61,
    JG_E_GET_STR_CHAR_C_TOO_FEW = 62,
    JG_E_GET_STR_CHAR_C_TOO_MANY = 63,
    JG_E_GET_NUM_NOT_INTEGER = 64,
    JG_E_GET_NUM_NOT_UNSIGNED = 65,
    JG_E_GET_NUM_SIGNED_TOO_SMALL = 66,
    JG_E_GET_NUM_SIGNED_TOO_LARGE = 67,
    JG_E_GET_NUM_UNSIGNED_TOO_SMALL = 68,
    JG_E_GET_NUM_UNSIGNED_TOO_LARGE = 69,
    JG_E_GET_NUM_NOT_FLO = 70,
    JG_E_GET_NUM_FLOAT_OUT_OF_RANGE = 71,
    JG_E_GET_NUM_DOUBLE_OUT_OF_RANGE = 72,
    JG_E_GET_NUM_LONG_DOUBLE_OUT_OF_RANGE = 73
} jg_ret;
